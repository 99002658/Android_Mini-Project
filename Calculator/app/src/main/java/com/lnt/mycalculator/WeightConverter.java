...
public class WeightConverter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = ArrayAdapter.createFromResource(this, R.array.wunits, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Wconverter.Unit fromUnit = Wconverter.Unit.fromString(fromString);
        Wconverter.Unit toUnit = Wconverter.Unit.fromString(toString);

        // Create a converter object and convert!
        Wconverter converter = new Wconverter(fromUnit, toUnit);
